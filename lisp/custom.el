(custom-set-variables
 ...
 '(package-selected-packages
   '(flyspell-correct-ivy diminish yapfify company-anaconda anaconda-mode spaceline py-isort flycheck counsel-projectile jedi elpy go-dlv company-go go-guru go-eldoc go-autocomplete go-mode multiple-cursors treemacs-persp treemacs-icons-dired treemacs-evil gnu-elpa-keyring-update bash-completion swiper counsel smartparens popwin iedit helm-ag htmlize eglot monokai-theme nova-theme spacemacs-theme)))
(custom-set-faces
